...
<body style="background:#dddddd">
  ...
  <div style="height:290px;width:260px;margin:64px 15px 15px auto; float:left; display:flex; align-items:center;justify-content:flex-end">
    <img src="https://github.com/xiangz-nudt/xiangz-nudt.github.io/blob/master/Pic.jpg?raw=true" alt="Xiang Zhao, NUDT">
  </div>
  <div style="height:280px;width:570px;margin:60px auto 30px 20px;float:left">
