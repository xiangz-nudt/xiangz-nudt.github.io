...
<body style="background:#dddddd">
  ...
  <div style="height:290px;width:260px;margin:65px 15px 15px auto; float:left; display:flex; align-items:center;justify-content:flex-end">
    <img src="profile.jpg" alt="Xiang Zhao"
         style="object-fit:scale-down; object-position:center; width:200px; height:300x" />
  </div>
...
<div style="width:860px;margin:0px auto">
  ...
  <b>Xiang Zhao</b>, <a href="https://sites.google.com/site/chuanxiao1983/" target="_blank">Chuan Xiao</a>*, <a href="http://www.cse.unsw.edu.au/~lxue/" target="_blank">Xuemin Lin</a>, <a href="http://www.cse.unsw.edu.au/~zhangw/" target="_blank">Wenjie Zhang</a>, <a href="https://sites.google.com/view/wayag/home" target="_blank">Yang Wang</a>. <i><b>VLDB J.</b></i>, 2018, 27(1): 53-78.</p></li>
    ...
    <li><p><b><a href="">一种面向云边端的分层异构联邦学习方法</a></b><br/>钟正仪, 包卫东, 王吉*, 吴冠霖, <b>赵翔</b>. <b><i>计算机研究与发展</i></b>, 2022, 待刊.</p></li>
